#!/bin/bash
# Script to run targeted GPU profiling experiments.
...
BASE_RESULTS_DIR="gpu_profiling_experiments"
...
a100_models_edp["v_deepseek_32b"]=true
a100_models_edp["vllama_bbh_3_1_8b"]=true

declare -a a100_models=(
    "v_deepseek_32b" "vllama_bbh_3_1_8b" "vllama_3_1_8b" "v_mistral_7b"
    "qwen3_30b_3a"
    "pythia_14m" "pythia_70m" "pythia_160m" "pythia_410m" "pythia_1b" 
    "pythia_1_4b" "pythia_2_8b" "pythia_6_9b" "pythia_12b"
)
...
a4500_models_edp["vllama_3_1_8b"]=true

declare -a a4500_models=(
    "vllama_3_1_8b"
    "int4_vllama_3_1_8b" "int8_vllama_3_1_8b" "int8_w16_vllama_3_1_8b"
)
