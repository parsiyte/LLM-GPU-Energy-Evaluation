...
for model in "${models[@]}"; do
  ...
  model_script="/data/test/lm-evaluation-harness/${model}.sh"
...
final_results_dir="vllama_cnn_3_1_8b_results_a100" # Updated for the specific model
mkdir -p "$final_results_dir"

echo "Moving results to $final_results_dir..."
for model in "${models[@]}"; do # This loop will run once for vllama_cnn_3_1_8b
  experiments_parent_dir="${model}_experiments"
